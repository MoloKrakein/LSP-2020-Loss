  ...
  <body class="bg-dark">
    ...
    <form method="POST" action="tambah_menu.php">
      <div class="form-group">
        ...
        <input type="text" name="nama" class="form-control" placeholder="Menu">
      </div>
      <div class="form-group">
        ...
        <select class="form-control" name="koki" id="exampleFormControlSelect1">
          <?php
          include("koneksi.php");
          $querykoki = mysqli_query($db,"SELECT * FROM `koki`");
          while($koki = mysqli_fetch_array($querykoki)){
          ?>
          <option value="<?php echo $koki['id_koki']?>"><?php echo $koki['nama_koki']?></option>
          <?php
          }
          ?>
        </select>
      ...
      <div class="form-group">
        ...
        <input type="number" required name="angka" class="form-control" placeholder="Harga">
      </div>
